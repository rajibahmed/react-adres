...
var routes = _react2['default'].createElement(_reactRouter.Route, {path: '/'}, _react2['default'].createElement(_reactRouter.Route, {path: 'parent'}, _react2['default'].createElement(_reactRouter.Route, {path: 'child/:id'})));
describe('reduxRouter()', function() {
  ...
  it('detects external router state changes', function() {
    var baseReducer = _redux.combineReducers({router: _.routerStateReducer});
    var EXTERNAL_STATE_CHANGE = 'EXTERNAL_STATE_CHANGE';
    var externalState = {location: {
  ...
  describe('onEnter hook', function() {
    it('can perform redirects', function() {
      ...
      var store = _.reduxReactRouter({
        history: history,
        routes: _react2['default'].createElement(_reactRouter.Route, {path: '/'}, _react2['default'].createElement(_reactRouter.Route, {path: 'parent'}, _react2['default'].createElement(_reactRouter.Route, {
          path: 'child/:id',
          onEnter: requireAuth
