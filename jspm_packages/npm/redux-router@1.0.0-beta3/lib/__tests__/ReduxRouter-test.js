...
var _historyLibCreateMemoryHistory = require("../../node_modules/history/lib/createMemoryHistory");
...
var App = (function(_Component) {
  ...
  App.prototype.render = function render() {
    ...
    return _react2['default'].createElement('div', null, _react2['default'].createElement('p', null, 'Pathname: ' + location.pathname), children);
  };
...
var Parent = (function(_Component2) {
  ...
  Parent.prototype.render = function render() {
    return _react2['default'].createElement('div', null, _react2['default'].createElement(_reactRouter.Link, {
      to: '/parent/child/321',
      query: {key: 'value'}
    }), this.props.children);
  };
...
var routes = _react2['default'].createElement(_reactRouter.Route, {
  ...
  path: 'redirect',
  onEnter: redirectOnEnter('/parent/child/850')
}));
describe('<ReduxRouter>', function() {
  _mochaJsdom2['default']();
  function renderApp() {
    var reducer = _redux.combineReducers({router: _.routerStateReducer});
    ...
    return _reactAddonsTestUtils.renderIntoDocument(_react2['default'].createElement(_reactRedux.Provider, {store: store}, _react2['default'].createElement(_.ReduxRouter, null, routes)));
  }
  ...
  describe('server-side rendering', function() {
    it('works', function() {
      ...
      store.dispatch(server.match('/parent/child/850', function() {
        var output = _reactDomServer.renderToString(_react2['default'].createElement(_reactRedux.Provider, {store: store}, _react2['default'].createElement(_.ReduxRouter, null)));
  ...
  describe('dynamic route switching', function() {
    it('updates routes wnen <ReduxRouter> receives new props', function() {
      var newRoutes = _react2['default'].createElement(_reactRouter.Route, {
        path: '/parent/:route',
        component: App
      });
      var reducer = _redux.combineReducers({router: _.routerStateReducer});
      ...
      var RouterContainer = (function(_Component4) {
        ...
        RouterContainer.prototype.render = function render() {
          return _react2['default'].createElement(_reactRedux.Provider, {store: store}, _react2['default'].createElement(_.ReduxRouter, {routes: this.state.routes}));
        };
